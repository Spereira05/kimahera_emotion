...
try {
                            ...
                            <div class='col-lg-8'>
                                ...
                                <form method='get' name='alunos' class='mb-3'>
                                    ...
                                    <div class='position-relative'>
                                        ...
                                        <!-- Clear Button -->
                                        <button type='button' id='clear-search-btn' class='btn btn-outline-secondary btn-sm position-absolute top-50 end-0 translate-middle-y me-2 d-none' style='z-index: 10;'>
    ...
    $(document).ready(function() {
        ...
        function selectStudent(studentId) {
            ...
            // Submit form to reload page with selected student (this makes mensalidade work)
        ...
        clearBtn.on('click', function() {
            ...
            window.location.href = '?p=horario';
        });

        // Hide dropdown when clicking outside
        $(document).on('click', function(e) {
            if (!$(e.target).closest('#student-search-enhanced, #autocomplete-dropdown, #clear-search-btn').length) {
                dropdown.addClass('d-none');
                selectedIndex = -1;
            }
        });
